    ...
    <DefaultLayout>
      <div className={styles.experienceContainer}>
        ...
        dove è possibile vedere il prezzo totale che l'utente pagherà`
          ...
          <a rel="noreferrer" href='https://andrea2601.github.io/thriller-movie/' target="_blank"  className={styles.experience}>
          ...
          <a rel="noreferrer" href='https://vuegram-igclone.vercel.app/#/' target="_blank"  className={styles.experience}>
          ...
          <a rel="noreferrer" href='https://vuemapp.vercel.app/' target="_blank"  className={styles.experience}>
          ...
          <a rel="noreferrer" href='https://andrea2601.github.io/movie-db/' target="_blank"  className={styles.experience}>
          ...
          <a rel="noreferrer" href='https://andrea2601.github.io/ecommerce_react/' target="_blank"  className={styles.experience}>
