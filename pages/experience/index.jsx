    ...
    <DefaultLayout>
      <div className={styles.experienceContainer}>
        ...
        <div className={styles.experiences}>
          <a href='https://andrealogiudice.vercel.app/' target="_blank"  className={styles.experience}>
        ...
        dove è possibile vedere il prezzo totale che l'utente pagherà`
          ...
          <a href='https://andrea2601.github.io/thriller-movie/' target="_blank"  className={styles.experience}>
          ...
          <a href='https://vuegram-igclone.vercel.app/#/' target="_blank"  className={styles.experience}>
          ...
          <a href='https://vuemapp.vercel.app/' target="_blank"  className={styles.experience}>
          ...
          <a href='https://andrea2601.github.io/movie-db/' target="_blank"  className={styles.experience}>
          ...
          <a href='https://andrea2601.github.io/ecommerce_react/' target="_blank"  className={styles.experience}>
